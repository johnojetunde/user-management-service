...
@Configuration
@EnableJpaRepositories(basePackages = "com.iddera.usermanagementservice",
                       entityManagerFactoryRef = "idderaEntityManagerFactory",
                       transactionManagerRef = "idderaTransactionManager")
public class IdderaDataConfig {
    ...
    @Bean(name = {"idderaDataSource"})
    @Primary
    public DataSource idderaDataSource() {
    ...
    public LocalContainerEntityManagerFactoryBean idderaManagerFactory(
        ...
        return builder
                .dataSource(idderaDataSource())
                .packages(
                        "com.iddera.usermanagementservice"
                )
    ...
    @Bean
    @Primary
    public SpringLiquibase liquibase(@Qualifier("idderaDataSource") DataSource dSource) {
