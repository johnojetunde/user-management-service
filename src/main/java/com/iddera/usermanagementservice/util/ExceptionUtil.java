...
import com.iddera.usermanagementservice.exception.ApiException;
...
public class ExceptionUtil {
    ...
    public static CompletableFuture<Boolean> completeBooleanExceptionally(String message) {
        return completeExceptionally(new UserManagementException(message));
    }
    ...
    public static RuntimeException createNotImplementedException(String msg) {
        return new UserManagementException(NOT_IMPLEMENTED.value(), msg);
    }
    ...
    private static UserManagementException userMgtException(String msg, Throwable ex) {
        logException(msg, ex);
        return new UserManagementException(msg, ex, findExceptionCode(ex), null);
    }

    private static UserManagementException userMgtException(String msg, int code) {
        log.error(msg);
        return new UserManagementException(code, msg);
    }
