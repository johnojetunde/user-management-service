...
public class TemplateConstants {
    public static final String TEMPLATE = "welcome-template";
    ...
    public static final String ACTIVATE_USER_MINI_TITLE = "It's awesome to have you on board.";
    public static final String LOGIN_TITLE_MINI_TITLE = "Welcome Back!";
    ...
    public static final String ACTIVATE_USER_BUTTON = "Activate";

    public static final String ACTIVATION_KEY = "activationLink";
